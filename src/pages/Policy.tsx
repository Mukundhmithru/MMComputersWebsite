...
export function Policy() {
  return (
    <div id="Policy" className="mm-section">
      <div className="mm-container">
        <div>
          ...
          >
            Fair & Transparent We believe in clear, honest pricing with no
            surprises - நியாயமான மற்றும் வெளிப்படையான கட்டணம்
          </p>
          ...
          >
            Service-based charges – Fees depend on the type of service and the
            effort involved. Sometimes, after reviewing your documents, we may
            suggest additional related services to ensure your work is completed
            successfully - சேவை அடிப்படையிலான கட்டணம்
          </p>
          <p
            style={{
              color: "#94a3b8",
          ...
          >
            No hidden costs – Any extra work and updated charges will be
            discussed with your approval before we start - மறைமுக கட்டணங்கள்
            இல்லை
          </p>
        </div>
        <h2
