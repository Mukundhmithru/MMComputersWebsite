...
export function Header() {
  ...
  return (
    <header style={{ position: 'sticky', top: 0, zIndex: 1000, backgroundColor: '#0f172a', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
      {/* Top info bar (desktop only) */}
      <div className="header-top" style={{ alignItems: 'center', justifyContent: 'space-between', padding: '4px 16px', fontSize: '12px', color: 'rgba(255,255,255,0.8)', width: '100%', margin: '0 auto', display: 'none' }}>
        <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
          <div style={{ display: 'flex', gap: '6px', alignItems: 'center', cursor: 'pointer' }} onClick={handleEmailClick}>
      ...
      {/* Main nav bar */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px', minHeight: '64px', width: '100%', margin: '0 auto' }}>
        {/* Logo / brand */}
        ...
        <nav className="header-nav" style={{ flexGrow: 1, justifyContent: 'center', gap: '8px', display: 'none' }}>
          {navItems.map((item) => {
        ...
        <div className="header-actions" style={{ alignItems: 'center', gap: '12px', display: 'none' }}>
          <div
            style={{
              display: 'flex',
              alignItems: 'center',
      ...
      {mobileOpen && (
        <div className="mobile-drawer" style={{
          ...
          <div style={{ borderBottom: '1px solid #334155', marginBottom: '16px' }}></div>
          <div style={{ marginBottom: '16px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div style={{ display: 'flex', gap: '6px', alignItems: 'center', cursor: 'pointer' }} onClick={handleEmailClick}>
                <span>✉</span>
                <span style={{ color: 'white', fontSize: '14px' }}>Click To Email</span>
              </div>
              <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                <span>🕒</span>
              ...
              <div style={{ display: 'flex', gap: '6px', alignItems: 'center', cursor: 'pointer' }} onClick={handleWhatsappClick}>
                ...
                <span style={{ color: 'white', fontSize: '14px' }}>Click To WhatsApp</span>
              </div>
            </div>
          </div>
          <div style={{ borderBottom: '1px solid #334155', marginBottom: '16px' }}></div>
